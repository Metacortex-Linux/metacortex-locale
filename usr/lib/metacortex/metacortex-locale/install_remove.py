...
import locale
import codecs
import metacortexcommon.aptdaemon
...
class MetacortexLocale:
    ...
    def __init__(self):
        ...
        self.language_packs = []
        with codecs.open("/usr/share/metacortex/metacortex-locale/language_packs", 'r', encoding='utf-8') as f:
            for line in f:
                line = line.strip()
                columns = line.split(":")
                if len(columns) == 4:
        ...
        self.builder.add_from_file('/usr/share/metacortex/metacortex-locale/install_remove.ui')
        ...
        self.apt = metacortexcommon.aptdaemon.APT(self.window)
    ...
    def button_add_clicked(self, button):
        os.system("/usr/lib/metacortex/metacortex-locale/add.py")
        self.build_lang_list()
