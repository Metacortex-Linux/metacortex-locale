...
class MetacortexLocale:
    ...
    def __init__(self):
        ...
        self.builder.add_from_file('/usr/share/metacortex/metacortex-locale/add.ui')
    ...
    def button_install_clicked(self, button):
        ...
        if os.path.exists("/var/lib/locales/supported.d"):
            os.system("localedef --list-archive | sed 's/utf8/UTF-8 UTF-8/g' > /var/lib/locales/supported.d/metacortex-locale")
        sys.exit(0)
