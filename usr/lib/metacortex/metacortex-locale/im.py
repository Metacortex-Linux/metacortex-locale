...
class IMLanguage():
    ...
    def __init__(self, codename, methods, button, app):
        ...
        self.apt = metacortexcommon.aptdaemon.APT(self.app.window)
        self.button = button
        ...
        # load package list
        info_paths = []
        info_paths.append("/usr/share/metacortex/metacortex-locale/iminfo/locale/%s.info" % codename)
        for input_method in methods.split(":"):
            info_paths.append("/usr/share/metacortex/metacortex-locale/iminfo/%s.info" % input_method)
...
class IM:
    ...
    def __init__(self):
        ...
        self.builder.add_from_file('/usr/share/metacortex/metacortex-locale/im.ui')

        self.window = self.builder.get_object("main_window")
        self.window.set_title(_("Input Method"))
        XApp.set_window_icon_name(self.window, "metacortex-locale-im")
